...
class XLerobot(Robot):
    ...
    def __init__(self, config: XLerobotConfig):
        ...
        print("debug: calibration1", calibration1, flush=True)
        ...
        print("debug: calibration2", calibration2, flush=True)
    ...
    def is_calibrated(self) -> bool:
        print("debug: is_calibrated", self.bus1.is_calibrated, self.bus2.is_calibrated, flush=True)
